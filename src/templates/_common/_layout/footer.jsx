...
const StatusNotification = () => (
  <div id="status_notification">
    <div id="status_notification_type">
      <img
        src={it.url_for("images/server_status/ic-warning.svg")}
    ...
    <div id="status_notification_close">
      <img
        src={it.url_for("images/server_status/ic-close.svg")}
        alt="Warning icon"
      />
    </div>
  </div>
...
const DialogNotification = () => (
  <div id="dialog_notification" className="primary-bg-color">
    <p id="dialog_notification_text">
      {it.L(
        "Our website uses cookies to give you the best user experience. For more information, [_1]view our policy[_2].",
        `<a href="${it.url_for(
          "terms-and-conditions"
        )}?anchor=cookies-and-device-information#privacy" target="_blank" rel="noopener noreferrer">`,
        "</a>"
      )}
    </p>
    <a
      className="button-secondary gr-gutter-left gr-no-gutter-m"
      id="dialog_notification_accept"
      type="button"
    >
      <span>{it.L("OK")}</span>
    </a>
...
const Footer = () => (
  <div id="footer" className="no-print">
            ...
            <div className="gr-row">
              <FooterColumn
                ...
                items={[
                  ...
                  {
                    text: it.L("Group History"),
                    href: it.url_for("group-history"),
                  },
                  {
                    text: it.L("Binary.com in Numbers"),
                    href: it.url_for("binary-in-numbers"),
                  },
                  {
                    text: it.L("Careers"),
                    href: it.deriv_career_url,
                    target: "_blank",
                  },
                  {
                    text: it.L("Patents"),
                    href: it.url_for("legal/us_patents"),
                  },
              ...
              <FooterColumn
                ...
                items={[
                  ...
                  {
                    text: it.L("Keep Safe"),
                    href: it.url_for("keep-safe"),
                    className: "client_logged_out invisible",
                  },
                ]}
              />
              ...
              <FooterColumn
                ...
                items={[
                  ...
                  {
                    text: it.L("Payment Methods"),
                    href: it.url_for("cashier/payment_methods"),
                  },
                ]}
              />
            </div>
          ...
          <div className="gr-6 gr-12-m gr-parent gr-no-gutter">
            <div className="gr-row">
              <FooterColumn
                ...
                items={[
                  {
                    text: it.L("Regulatory Information"),
                    href: it.url_for("regulation"),
                  },
                  {
                    text: it.L("Terms and Conditions"),
                    href: it.url_for("terms-and-conditions"),
                  },
                  {
                    text: it.L("Security and Privacy"),
                    href: it.url_for("terms-and-conditions"),
                    param: "?anchor=security-and-privacy#privacy",
                  },
                  {
                    text: it.L("Responsible Trading"),
                    href: it.url_for("responsible-trading"),
                  },
                ]}
              />
              ...
              <FooterColumn
                ...
                items={[
                  ...
                  {
                    text: it.L("Asset Index"),
                    href: it.url_for("resources/asset_indexws"),
                    dataShow: "-maltainvest, -optionsblocked",
                  },
                  {
                    text: it.L("Trading Times"),
                    href: it.url_for("resources/market_timesws"),
                    dataShow: "-maltainvest, -optionsblocked",
                  },
                  {
                    text: it.L("Network Status"),
                    href: "https://binarycom.statuspage.io",
                    target: "_blank",
                  },
                ]}
              />
              ...
              <FooterColumn
                ...
                items={[
                  {
                    text: it.L("Affiliate and IB Programme"),
                    href: it.url_for("affiliate-ib"),
                  },
                  {
                    text: it.L("API"),
                    href: "https://developers.binary.com",
                    target: "_blank",
                  },
                  /* { text: it.L('Charitable Activities'),   href: it.url_for('charity') }, */
                  {
                    text: it.L("All Partnership Options"),
                    href: it.url_for("partners"),
                  },
                ]}
              />
            </div>
      ...
      <div className="container" data-show="-eucountry">
              ...
              <div className="regulation-logos flex-row">
                ...
                >
                  <img
                    ...
                    src={it.url_for("images/pages/regulation/vanuatu-logo.png")}
                  />
                </a>
                <a
                  className="bvi-icon"
                ...
                >
                  <img
                    className="responsive"
                    src={it.url_for("images/pages/regulation/bvi.png")}
                  />
                </a>
                <a
                  className="labuan-icon"
                ...
                >
                  <img
                    className="responsive"
                    src={it.url_for("images/pages/footer/labuan_FSA.svg")}
                  />
                </a>
              </div>
              <SocialIcons
                ...
                networks={[
                  {
                    media: "youtube",
                    href: "https://www.youtube.com/user/BinaryTradingVideos",
                  },
                  {
                    media: "facebook",
                  ...
                  {
                    media: "twitter",
                    href: "https://www.twitter.com/derivdotcom",
                  },
        ...
        <div className="gr-row">
          <div className="gr-12">
            <p>
              {it.L(
                "In the EU, financial products are offered by Deriv Investments (Europe) Limited, W Business Centre, Level 3, Triq Dun Karm, Birkirkara, BKR 9033, Malta, regulated as a Category 3 Investment Services provider by the Malta Financial Services Authority ([_1]licence no. IS/70156[_2]).",
                `<a href=${it.url_for(
            ...
            <p>
              {it.L(
                "Outside the EU, financial products are offered by Deriv (SVG) LLC, Hinds Building, Kingstown, St. Vincent and the Grenadines; Deriv (V) Ltd, Govant Building, Port Vila, PO Box 1276, Vanuatu, regulated by the Vanuatu Financial Services Commission ([_1]view licence[_2]); Deriv (BVI) Ltd, Kingston Chambers, P.O. Box 173, Road Town, Tortola, British Virgin Islands, regulated by the British Virgin Islands Financial Services Commission ([_3]licence no. SIBA/L/18/1114[_4]); and Deriv (FX) Ltd, Lot No. F16, First Floor, Paragon Labuan, Jalan Tun Mustapha, 87000 Labuan, Malaysia, regulated by the Labuan Financial Services Authority to carry on a money-broking business ([_5]licence no. MB/18/0024[_6]).",
                `<a href=${it.url_for(
            ...
            <div className="icon-row flex-row">
              <div className="regulation-logos flex-row">
                <div className="mga-gamstop-icon-container">
                  <a
                    className="mga-icon"
                    href="https://www.authorisation.mga.org.mt/verification.aspx?lang=EN&company=a5fd1edc-d072-4c26-b0cd-ab3fa0f0cc40&details=1"
                    target="_blank"
                    rel="noopener noreferrer"
                  >
                    <img
                      className="responsive"
                      src={it.url_for(
                        "images/pages/footer/mga-logo-footer.svg"
                      )}
                    />
                  </a>
                </div>
                <div className="age-restriction-sign">
                  <img
                    className="responsive"
                    src={it.url_for("images/pages/footer/18+.svg")}
                  />
                </div>
              </div>
              <SocialIcons
                ...
                networks={[
                  ...
                  {
                    media: "facebook",
                    href: "https://www.facebook.com/derivUK/",
                  },
                  {
                    media: "twitter",
                    href: "https://www.twitter.com/deriv_uk/",
                  },
                  {
                    media: "instagram",
                    href: "https://www.instagram.com/deriv_uk/",
                  },
                  { media: "telegram", href: "https://t.me/binarydotcom" },
                  {
                    media: "reddit",
    ...
    <div
      id="end-note"
      className="invisible content-inverse-color center-text"
    />
    <StatusNotification />
    <DialogNotification />
  </div>
